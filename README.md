...
* This repo provides the codebase and dataset of work **WORD: A large scale dataset, benchmark and clinical applicable study for abdominal organ segmentation from CT image**. Now, this work has been fully accepted by **Medical Image Analysis**, and each download requirement will be approved **within two days**.
